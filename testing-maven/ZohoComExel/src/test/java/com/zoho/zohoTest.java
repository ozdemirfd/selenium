...
public class zohoTest {
	...
	String path = "/Users/fd/selenium/testing-maven/ZohoComExel/src/test/resources/config.properties";
	String excelPath="/Users/fd/Desktop/zoho.xlsx";
	Properties prop;
	...
	public void printExel() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#reportTab>tbody>:nth-child(20)")));
			...
			List<WebElement> columns=driver.findElements(By.cssSelector("#reportTab>tbody>tr:nth-child(3)>td"));
